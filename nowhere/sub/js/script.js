...
$(".notice_thumbnail_link li:nth-child(3)").click(function(){
    $("body").addClass("scroll_none");
    $(".notice_popup4").fadeIn();
    $(".popup_close").fadeIn();
    $(".oppacity_box2").fadeIn();
});

$(".popup_close").click(function(){
    $("body").removeClass("scroll_none");
    $(".notice_popup4").fadeOut();
    $(".popup_close").fadeOut();
    $(".oppacity_box2").fadeOut();
});

$(".notice_thumbnail_link li:nth-child(4)").click(function(){
    $("body").addClass("scroll_none");
    $(".notice_popup3").fadeIn();
    $(".popup_close").fadeIn();
    $(".oppacity_box2").fadeIn();
});
...
$(".notice_thumbnail_link li:nth-child(1)").click(function(){
    $("body").addClass("scroll_none");
    $(".notice_popup2").fadeIn();
    $(".popup_close").fadeIn();
    $(".oppacity_box2").fadeIn();
});
...
$(".notice_thumbnail_link li:nth-child(2)").click(function(){
    $("body").addClass("scroll_none");
    $(".notice_popup").fadeIn();
    $(".popup_close").fadeIn();
    $(".oppacity_box2").fadeIn();
...
$(".review_imgbox li:nth-child(1)").click(function(){
    $("body").addClass("scroll_none");
    $(".review_popup").fadeIn();
    $(".popup_close").fadeIn();
    $(".oppacity_box3").fadeIn();
});
...
$(".popup_close").click(function(){
    ...
    $(".popup_close").fadeOut();
    $(".oppacity_box3").fadeOut();
});

// 

$(".review_imgbox li:nth-child(2)").click(function(){
    $("body").addClass("scroll_none");
    $(".review_popup2").fadeIn();
    $(".popup_close").fadeIn();
    $(".oppacity_box3").fadeIn();
});
...
$(".review_imgbox li:nth-child(3)").click(function(){
    $("body").addClass("scroll_none");
    $(".review_popup3").fadeIn();
    $(".popup_close").fadeIn();
    $(".oppacity_box3").fadeIn();
});
...
$(".review_imgbox li:nth-child(4)").click(function(){
    $("body").addClass("scroll_none");
    $(".review_popup4").fadeIn();
    $(".popup_close").fadeIn();
    $(".oppacity_box3").fadeIn();
});
...
$(function(){
	$(".accordion> ul> li").click(function(){
		$(this).children(".accordion_text_info").slideToggle();
		$(this).siblings().children(".accordion_text_info").slideUp();
	});
});
$(function(){
	$(".accordion> ul> li").click(function(){
...
$(window).scroll(function () {
    ...
    if (height > 370) {//아이콘이 나타나길 원하는 높이를 설정하세요
